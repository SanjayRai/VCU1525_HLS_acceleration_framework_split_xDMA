...
#define AXI_LITE_KERNEL_DATASET        0x00070000UL
#define AXI_LITE_KERNEL_CLOCK_COUNT    0x00070008UL
...
void fpga_get_Kernel_execution_time (fpga_xDMA_winX *fpga_AXI_Lite_ptr, double kernel_operating_frequency, kernel_execution_metric_struct *kernel_execution_metric);
