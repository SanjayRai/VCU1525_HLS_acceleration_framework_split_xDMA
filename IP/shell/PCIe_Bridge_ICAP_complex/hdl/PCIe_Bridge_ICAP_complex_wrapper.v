...
module PCIe_Bridge_ICAP_complex_wrapper
  ...
  wire clk_out_250M;
  wire clk_out_PROG;
  wire clk_out_PROG_locked;
  wire [31:0]ker_active_count_L;
  wire [31:0]ker_active_count_U;
  ...
  PCIe_Bridge_ICAP_complex PCIe_Bridge_ICAP_complex_i
       (.C1_SYS_CLK_clk_n(C1_SYS_CLK_clk_n),
        ...
        .ker_active_count_L(ker_active_count_L),
        .ker_active_count_U(ker_active_count_U),
