...
################################################################
# This is a generated script based on design: bd_84e7
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./PCIe_Bridge_ICAP_complex/ip/PCIe_Bridge_ICAP_complex_system_ila_AXIL_0/bd_0
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_0_AXI_ARUSER_WIDTH {11} \
   CONFIG.C_SLOT_0_AXI_AR_SEL {1} \
   CONFIG.C_SLOT_0_AXI_AWUSER_WIDTH {11} \
